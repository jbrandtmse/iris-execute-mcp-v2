...
- **85 tools** across 5 specialized MCP servers (up from 8 in a single server)
...
| **Architecture** | Single server, 8 tools | 5 servers, 85 tools total |
...
|------------|--------|------------|
| `@iris-mcp/dev` | Development, compilation, execution, globals, SQL | 21 |

...
2026-09-11T08:26:00Z	Story 34.5	dev_complete_CORRECTION	corrects=line58(2026-08-15T01:30:00Z) field=tests_added original_value=18 corrected_value=14 reason=18_was_a_FINAL-DIFF_figure(dev+QA+CR combined in one squashed commit d8a8159), not the dev-stage count; mechanically re-derived 2026-09-11 (Story 36.3, ledger 34-5-R5) via `git diff afe6884 d8a8159` over the story's own touched test files: execute.test.ts shows 18 net new `it(` blocks in the FINAL tree, of which QA's own Results section (this story file, "3 new tests added") attributes 3, and the code-review's own resolved-count attributes the remainder beyond dev's original 14 — cross-checked consistent with QA's/CR's own recorded deltas; no historical line above is edited (append-only) model=claude-sonnet-5
2026-09-11T10:51:35Z	Story 34.5	dev_complete_CORRIGENDUM	corrects=the_2026-09-11T08:26:00Z_dev_complete_CORRECTION_line field=derivation value=14_STANDS derivation=git_show_afe6884_vs_d8a8159_it-block_count:execute.test.ts_40_to_56_plus16+errors.test.ts_plus3+http-client.test.ts_plus3;minus_CR_plus6_(dev_tests_632_to_638)_minus_QA_net_plus2_(630_to_632)=8_in_execute.test.ts+6_shared_dev-only_files=14 prior_line_errors=cited_18_net_new_it_blocks_(mechanical_16)+circular_from_original_14 authority=deferred-work.md_34-5-R5_last_row_(Story_36.3_code_review) author=epic-cycle_lead(claude-opus-5)_Story_36.3_smoke

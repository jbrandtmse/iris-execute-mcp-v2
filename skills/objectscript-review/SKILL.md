...
# packages/iris-dev-mcp/src/prompts/*.ts (source prompt: "objectscript-review").
# Regenerate via: pnpm gen:skills
name: objectscript-review
description: "A concise (<=300 word) pre-write checklist distilling the project's ObjectScript conventions ($$$ macros, Quit-in-try/catch, %OnNew/initvalue, no-underscore names, storage sections untouchable, deploy/test discipline)."
---

# ObjectScript Pre-Write Checklist

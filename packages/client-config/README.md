...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Claude Code (`claude-code`) | json | `mcpServers` | `~/.claude.json` | `.mcp.json` | manager stash | Restart Claude Code (or start a new session) for MCP changes to take effect. | **certified-live** 2026-07-28 |
...
| Kimi Code (`kimi-code`) | json | `mcpServers` | `~/.kimi-code/mcp.json` (or $KIMI_CODE_HOME/mcp.json) | `.kimi-code/mcp.json` | manager stash | Restart Kimi Code (or start a new session) for MCP changes to take effect. | **certified-live** 2026-07-28 |
<!-- ADAPTER-TABLE:END -->

 ...
 * constructs a real `@iris-mcp/ops` server or drives `prompts/list` — they
...
/** The prompts this package (iris-ops-mcp) owns per Story 25.1 AC 25.1.1. */
const OWN_PROMPT_NAMES = ["check-system-health", "run-external-backup"];
...
describe("iris-ops-mcp real server prompts/list (AC 25.1.1, AC 25.0.3)", () => {

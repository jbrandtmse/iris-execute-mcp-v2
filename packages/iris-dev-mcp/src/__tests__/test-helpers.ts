/**
 * Shared test helpers for iris-dev-mcp tool unit tests.
 *
 * Consolidates `createMockHttp()`, `createMockCtx()`, and `envelope()`
 * that were previously duplicated across all six tool test files.
 */

import { vi } from "vitest";
import type { IrisHttpClient, ToolContext, IrisConnectionConfig, AtelierEnvelope, PaginateResult } from "@iris-mcp/shared";
